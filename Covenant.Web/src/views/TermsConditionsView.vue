  ...
  <div class="terms-page">
    ...
    <div class="terms-container">
      <div class="terms-content">
        <h1 class="terms-title">TERMS AND CONDITIONS OF SERVICE</h1>
        <p class="last-updated">Last Update: January 22, 2026</p>

        <div class="terms-text">
          <p>
            Welcome to COVENANT GROUP LTD., together with its partners, affiliates, subsidiaries, and related entities, including SIGOOK (collectively, "COVENANT GROUP"), website.
          </p>
          ...
          <p>
            These Terms constitute a legally binding agreement ("Agreement") between you and COVENANT GROUP (as defined below) governing access to and use of this website, including any subdomains thereof, and any other websites through which COVENANT GROUP makes it services available (collectively, the "Site"), and all associated services (collectively, the "Services"). The Site is referred to as "COVENANT GROUP Website". All of our other policies applicable to the use of the COVENANT GROUP Website, including the Company's Privacy Policy, are incorporated by reference into this Agreement.
          </p>
          ...
          <p>
            This Agreement is governed by the laws of the Province of Ontario, Canada, without giving effect to any principles of conflict of laws. COVENANT GROUP may provide the Services from, or make the Site accessible in, jurisdictions outside of Canada. Accordingly, information, content, or materials submitted through the Site may be processed or accessed outside Canada and may be subject to the laws of such jurisdictions. Use of the Site constitutes acceptance of such cross-border access and processing, subject always to the Company's Privacy Policy.
          </p>
          ...
          <h3>Permanent Recruitment Services</h3>
          <p>
            In addition to temporary or contingent staffing services, COVENANT GROUP may also provide permanent or direct placement recruitment services, whereby candidates may be introduced to employers for consideration for direct employment under the employer's payroll. COVENANT GROUP does not represent or warrant that any candidate will be offered or will obtain employment, and the decision to hire any candidate remains solely with the employer. Any individual engaged through a permanent placement shall be employed directly by the hiring employer, and COVENANT GROUP shall not be considered an employer or agent of such individual. Any fees, replacement arrangements, or guarantee periods related to permanent recruitment services, if applicable, shall be subject exclusively to the terms of a separate written agreement between COVENANT GROUP and the employer.
          </p>

          <h3>Use of Third-Party Systems and Applications</h3>
          <p>
            In connection with the provision of the Services, COVENANT GROUP may utilize third-party platforms, systems, or applications, including proprietary or affiliated solutions such as the SIGOOK application, to support recruitment, staffing, workforce management, and related administrative functions. Permitted uses of such systems or applications may include, but are not limited to, applying to open positions, communicating with COVENANT GROUP, recording time and attendance (including clock-in and clock-out), tracking work assignments or shifts, and, where permitted by applicable law, accessing employment-related documentation such as pay statements or pay stubs.
          </p>

          <p>
            You acknowledge and agree that the availability, accuracy, and functionality of such systems or applications may be affected by factors outside of COVENANT GROUP's control, including, without limitation, internet connectivity, mobile network coverage, device type, operating system, user settings, and geographic location. COVENANT GROUP does not guarantee uninterrupted access to, or the precision or accuracy of, any data captured through such systems, including location-based or time-tracking features, and shall not be responsible for any limitations, inaccuracies, or failures resulting from such external factors.
          </p>
          ...
          <h2>LIABILITY AND LIMITATIONS OF LIABILITY</h2>
          <p>
          ...
          <h2>APP USE DISCLAIMER</h2>
          <p>
            Any mobile application, platform, or system made available or referenced by COVENANT GROUP, including affiliated or third-party applications such as SIGOOK, is provided as a tool to facilitate certain recruitment, staffing, and workforce-related processes. Such applications are provided on an "as available" basis and are not intended to replace or override any employment agreement, assignment terms, client policies, or applicable laws. COVENANT GROUP does not warrant that any application will be continuously available, error-free, or compatible with all devices, operating systems, or network environments, and shall not be liable for any losses, delays, or discrepancies arising from the use or inability to use such applications, except to the extent required by applicable law.
          </p>
