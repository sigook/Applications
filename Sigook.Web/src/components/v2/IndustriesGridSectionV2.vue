<template>
  <section id="industries-grid" class="industries-grid-v2">
    <!-- Inner glass surface — materializes the panel against GlobalBackground -->
    <div class="industries-grid-v2__surface" aria-hidden="true"></div>

    <header class="industries-grid-v2__header">
      <EyebrowPillV2 variant="white" class="industries-grid-v2__eyebrow">
        Sectors We Serve
      </EyebrowPillV2>

      <h2 class="industries-grid-v2__heading">
        Eleven industries.
        <span class="industries-grid-v2__heading-accent">
          One commitment to specialized talent.
        </span>
      </h2>

      <p class="industries-grid-v2__subtitle">
        Explore the sectors where Sigook has the deepest expertise — tap any
        card to see the roles we place and how we partner.
      </p>
    </header>

    <div class="industries-grid-v2__grid">
      <IndustryCardV2
 ...
 *
 * Inside the panel: editorial header + 11 IndustryCardV2 in a responsive
...
import IndustryCardV2, { type Industry } from '@/components/v2/IndustryCardV2.vue'
...
.industries-grid-v2__eyebrow {
  margin-bottom: clamp(20px, 2.5vw, 28px);
}

.industries-grid-v2__heading {
...
.industries-grid-v2__heading-accent {
  color: var(--c-brand-cyan);
  display: block;
}

.industries-grid-v2__subtitle {
...
@media (max-width: 1023px) {
  .industries-grid-v2__grid { grid-template-columns: repeat(2, 1fr); }
}

@media (max-width: 599px) {
  .industries-grid-v2__grid { grid-template-columns: 1fr; }
}
</style>
