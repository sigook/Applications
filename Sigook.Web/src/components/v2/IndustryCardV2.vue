<template>
  ...
  >
    ...
    <div class="industry-card__content">
      <IndustryIconV2 :name="industry.key" class="industry-card__icon" />
...
<script lang="ts">
import type { IndustryIconName } from '@/components/v2/shared/IndustryIconV2.vue'

export type IndustryTone = 'cyan' | 'red'
...
/**
 * IndustryCardV2 — expandable card that transitions from "photo + gradient
...
import IndustryIconV2 from '@/components/v2/shared/IndustryIconV2.vue'
...
.industry-card--cyan .industry-card__base {
  background: linear-gradient(
    135deg,
    var(--c-brand-cyan) 0%,
    rgba(9, 48, 85, 0.95) 100%
  );
}
