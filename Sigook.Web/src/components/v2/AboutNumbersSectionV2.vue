<template>
  <section id="about-numbers" class="about-numbers-v2">
    <!-- Inner glass surface — materializes the panel against GlobalBackground,
         keeps shape consistency with DualCtaSectionV2 from Home. -->
    <div class="about-numbers-v2__surface" aria-hidden="true"></div>

    <header class="about-numbers-v2__header">
      <EyebrowPillV2 variant="cyan" class="about-numbers-v2__eyebrow">
        By the Numbers
      </EyebrowPillV2>

      <h2 class="about-numbers-v2__heading">
        A track record built
        <span class="about-numbers-v2__heading-accent">connection by connection.</span>
      </h2>

      <p class="about-numbers-v2__subtitle">
        Seventeen years of bringing people and opportunities together — and the
        numbers behind every story.
      </p>
    </header>

    <NumbersGridV2 :stats="ABOUT_STATS" class="about-numbers-v2__grid" />
  </section>
</template>
 ...
 *
 * Adopts the Home page panel vocabulary established by DualCtaSectionV2:
 ...
 *
 * Stats data lives here (page-owned content); NumbersGridV2 is a pure
 * layout atom.
 */
...
.about-numbers-v2__eyebrow {
  margin-bottom: clamp(20px, 2.5vw, 28px);
}

.about-numbers-v2__heading {
...
.about-numbers-v2__heading-accent {
  color: var(--c-brand-cyan);
  display: block;
}

.about-numbers-v2__subtitle {
  font-family: var(--font-family);
