  ...
  <div>
    ...
    <div class="highlight-content" v-if="props.request">
      ...
      <div class="item worker-options">
        <span class="has-text-weight-bold">Spots</span>
    ...
    <section class="mt-3">
      ...
      <span class="has-text-weight-normal">{{ props.request.jobPosition }}</span>
    </section>
    ...
    <section class="mt-5" v-if="props.request.incentive">
      ...
      <span class="has-text-weight-normal ml-2"> {{ currency(props.request.incentive) }}</span>
