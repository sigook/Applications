  ...
  <section>
    ...
    <div class="worker-documents">
      <div v-if="props.worker.identificationType1File && props.worker.identificationType1">
        ...
        <span>
          <p class="has-text-weight-light m-0">{{ props.worker.identificationNumber1 }}</p>
        </span>
      </div>
      <div v-if="props.worker.identificationType1File && props.worker.identificationType1">
      ...
      <div v-if="props.worker.identificationType2File && props.worker.identificationType2">
        ...
        <span>
          <p class="has-text-weight-light m-0">{{ props.worker.identificationNumber2 }}</p>
        </span>
      </div>
    ...
    <b-modal custom-content-class="card" v-model="modalDocuments" width="500px">
