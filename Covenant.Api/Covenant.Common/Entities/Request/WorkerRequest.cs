...
public class WorkerRequest
{
    ...
    public static WorkerRequest AgencyBook(Guid workerProfileId, Guid requestId, string createdBy = default) =>
        new WorkerRequest { WorkerProfileId = workerProfileId, RequestId = requestId, CreatedBy = createdBy, WorkerRequestStatus = WorkerRequestStatus.Booked };
}