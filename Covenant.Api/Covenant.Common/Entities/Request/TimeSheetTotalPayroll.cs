...
{
    public class TimeSheetTotalPayroll : ITimeSheetTotal
    {
        private TimeSheetTotalPayroll()
        {
        }

        public TimeSheetTotalPayroll(ITimeSheetTotal tst)
        {
            Id = tst.Id;
        ...
        public static TimeSheetTotalPayroll CreateTotal(
            Guid timeSheetId,
            TimeSpan totalHours,
        ...
        public static TimeSheetTotalPayroll CreateTotalWithOtherRegular(
            Guid timeSheetId,
            TimeSpan totalHours,
            TimeSpan regularHours,
