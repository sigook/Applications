...
public class RegularWageWorker
{
    ...
    public decimal AmountToPay
    {
        get
        {
            ...
            Description = $"The amount was calculated using the regular formula: (Regular wages ({RegularWage}) received during the last four weeks / 20)";
            return (RegularWage / TwentyDays).DefaultMoneyRound();
        }
    }
}