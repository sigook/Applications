        ...
        private async Task ValidateCandidateAsync(ProcessMessageEventArgs args)
        {
            ...
            if (message is not null)
            {
                ...
                if (candidateValidation.IsValid)
                {
                    ...
                    if (email)
                    {
                        ...
                        if (worker == null && candidate == null)
                        {
                            ...
                            {
                                response.ApplicationProperties[ServiceBusSqlConstants.ErrorCandidate] = $"Candidate with email: {email.Value.Email} is not registered";
                            }
                        }
                ...
                else
                {
                    ...
                    response.ApplicationProperties[ServiceBusSqlConstants.ErrorCandidate] = builder.ToString();
                }
