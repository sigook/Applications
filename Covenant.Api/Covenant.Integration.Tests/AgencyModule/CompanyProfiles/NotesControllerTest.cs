...
{
    public class NotesControllerTest : IClassFixture<CustomWebApplicationFactory<NotesControllerTest.Startup>>
    {
        ...
        private static string RequestUri() => NotesController.RouteName.Replace("{profileId}",
