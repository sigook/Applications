...
{
	public class ProvincialTaxMonthly : IProvincialTax
	{
		private ProvincialTaxMonthly(){}
		public ProvincialTaxMonthly(decimal @from, 
			decimal to,
			decimal? cc0, 
			decimal? cc1,
			decimal? cc2,
		...
		public ProvincialTaxMonthly(ITax tax)
		{
