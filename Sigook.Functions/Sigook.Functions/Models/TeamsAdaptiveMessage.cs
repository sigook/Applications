...
namespace Sigook.Functions.Models
{
    public class TeamsAdaptiveMessage
    {
        ...
        public static TeamsAdaptiveMessage FromNotification(TeamsMessage notification)
        {
            ...
            {
                Attachments = new List<TeamsAdaptiveAttachment> { new TeamsAdaptiveAttachment { Content = card } }
            };
        }
