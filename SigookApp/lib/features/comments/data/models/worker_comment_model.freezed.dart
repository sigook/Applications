...
bool operator ==(Object other) {
  final _this = this as WorkerCommentModel;
...
int get hashCode {
  final _this = this as WorkerCommentModel;
  return Object.hash(runtimeType,_this.id,_this.comment,_this.rate,_this.logo,_this.numberId,_this.createdAt);
}

@override
String toString() {
  final _this = this as WorkerCommentModel;
  return 'WorkerCommentModel(id: ${_this.id}, comment: ${_this.comment}, rate: ${_this.rate}, logo: ${_this.logo}, numberId: ${_this.numberId}, createdAt: ${_this.createdAt})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? comment = null,Object? rate = null,Object? logo = freezed,Object? numberId = null,Object? createdAt = null,}) {
  return _then(WorkerCommentModel(
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,comment,rate,logo,numberId,createdAt);
}
