...
class LicenseCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color = isExpired ? Colors.red.shade700 : Colors.green.shade700;
    final bgColor = isExpired ? Colors.red.shade50 : Colors.green.shade50;
    final borderColor = isExpired ? Colors.red.shade200 : Colors.green.shade200;
