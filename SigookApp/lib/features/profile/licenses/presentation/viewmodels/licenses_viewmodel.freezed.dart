...
bool operator ==(Object other) {
  final _this = this as LicensesState;
...
String toString() {
  final _this = this as LicensesState;
  return 'LicensesState(isUploading: ${_this.isUploading}, uploadError: ${_this.uploadError}, justUploaded: ${_this.justUploaded}, isDeleting: ${_this.isDeleting}, deleteError: ${_this.deleteError}, justDeleted: ${_this.justDeleted})';
}
