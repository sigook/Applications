...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  ...
  properties
    ...
    ..add(DiagnosticsProperty('isUploading', _this.isUploading))..add(DiagnosticsProperty('uploadError', _this.uploadError))..add(DiagnosticsProperty('justUploaded', _this.justUploaded));
}
...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  final _this = this as ProfileImageState;
  return 'ProfileImageState(isUploading: ${_this.isUploading}, uploadError: ${_this.uploadError}, justUploaded: ${_this.justUploaded})';
}
