...
bool operator ==(Object other) {
  final _this = this as PersonalDetailsState;
...
String toString() {
  final _this = this as PersonalDetailsState;
  return 'PersonalDetailsState(isEditing: ${_this.isEditing}, isSaving: ${_this.isSaving}, saveError: ${_this.saveError}, justSaved: ${_this.justSaved})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? isEditing = null,Object? isSaving = null,Object? saveError = freezed,Object? justSaved = null,}) {
  return _then(PersonalDetailsState(
