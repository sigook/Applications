...
bool operator ==(Object other) {
  final _this = this as PreferencesState;
...
String toString() {
  final _this = this as PreferencesState;
  return 'PreferencesState(isEditing: ${_this.isEditing}, isSaving: ${_this.isSaving}, saveError: ${_this.saveError}, justSaved: ${_this.justSaved})';
}
