...
bool operator ==(Object other) {
  final _this = this as ContactInfoState;
...
String toString() {
  final _this = this as ContactInfoState;
  return 'ContactInfoState(isEditing: ${_this.isEditing}, isSaving: ${_this.isSaving}, saveError: ${_this.saveError}, justSaved: ${_this.justSaved})';
}
