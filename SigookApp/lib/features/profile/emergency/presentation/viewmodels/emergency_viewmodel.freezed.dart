...
bool operator ==(Object other) {
  final _this = this as EmergencyState;
...
String toString() {
  final _this = this as EmergencyState;
  return 'EmergencyState(isEditing: ${_this.isEditing}, isSaving: ${_this.isSaving}, saveError: ${_this.saveError}, justSaved: ${_this.justSaved})';
}
